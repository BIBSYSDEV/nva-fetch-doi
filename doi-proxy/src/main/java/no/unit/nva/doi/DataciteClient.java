...
public class DataciteClient {
  ...
  protected URL createRequestUrl(String doiUrlString, DataciteContentType dataciteContentType)
    ...
    return new URL(
        dataciteBaseUrl, String.join("", dataciteContentType.getContentType(), doiUrl.getPath()));
  }

  public MetadataAndContentLocation fetchMetadata(
      String doiUrlString, DataciteContentType dataciteContentType) throws IOException {
