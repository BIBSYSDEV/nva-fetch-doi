...
public class MetadataServiceTest {
  ...
  void shouldReturnJournalIdFromPublicationChannelsByGivenJournalName() {
    ...
    var queryUri =
        createExpectedQueryUriForJournalName(expectedJournalName, String.valueOf(expectedYear));
    ...
    var actualId =
        metadataService
            .fetchJournalIdFromPublicationChannel(expectedJournalName, null, null, expectedYear)
            .orElseThrow();
  ...
  void shouldReturnPublisherIdFromPublicationChannelsByGivenPublisherName() {
    ...
    var metadataService = new MetadataService(httpClient, serverUriJournal, serverUriPublisher);
    var actualPublisherUri =
        metadataService.fetchPublisherIdFromPublicationChannel(expectedPublisherName);
    assertThat(actualPublisherUri, is(expectedPublisherUri));
  }

  @ParameterizedTest(name = "#{index} - {0}")
  @MethodSource({"provideMetadataWithLowercasePrefixes", "provideMetadataForAbstract"})
  void getCreatePublicationParsesHtmlAndReturnsMetadata(
      String ignored, String html, CreatePublicationRequest expectedRequest)
  ...
  @Test
  void getCreatePublicationRequestAddsTagsWhenTagsArePresent() throws MetadataFetchException {
    List<MetaTagPair> metaTags =
        List.of(
            new MetaTagPair("dcterms.coverage", "Coverage"),
    ...
    String[] expected =
        List.of("Coverage", "Temporal", "Spatial", "Subject").toArray(String[]::new);
  ...
  void getCreatePublicationReturnsValueWhenContentPrefixHasAnyCase(
      String tagAttribute, String value)
      throws IOException, InterruptedException, MetadataFetchException {
    Optional<CreatePublicationRequest> actual =
        getCreatePublicationRequestResponse(tagAttribute, value);
    assertTrue(actual.isPresent());
  }

  @ParameterizedTest(
      name = "getCreatePublication returns date when date attribute {0} with value {1}")
  ...
  void getCreatePublicationReturnsDateWhenDateVariantIsPresent(String tagAttribute, String date)
    ...
    var actual =
        getCreatePublicationRequest(tagAttribute, date).getEntityDescription().getPublicationDate();
    var expected =
        getCreatePublicationRequestWithDateOnly(date).getEntityDescription().getPublicationDate();
  ...
  void getCreatePublicationReturnsMostCompletePublicationDateWhenMultipleCandidatesArePresent()
    ...
    List<MetaTagPair> metaDates =
        List.of(new MetaTagPair(DC_DATE, YEAR_ONLY), new MetaTagPair(DC_DATE, FULL_DATE));

    var actualPublicationDate =
        getCreatePublicationRequest(metaDates).getEntityDescription().getPublicationDate();

    var expectedPublicationDate =
        getCreatePublicationRequestWithDateOnly(FULL_DATE)
  ...
  void getCreatePublicationReturnsValidDateWhenValidAndInvalidCandidatesAreAvailable(
      String nonsense) throws MetadataFetchException {
    var metaDates =
        List.of(new MetaTagPair(DC_DATE, VALID_DATE), new MetaTagPair(DC_DATE, nonsense));

    var actualPublicationDate =
        getCreatePublicationRequest(metaDates).getEntityDescription().getPublicationDate();

    var expectedPublicationDate =
        getCreatePublicationRequestWithDateOnly(VALID_DATE)
            .getEntityDescription()
            .getPublicationDate();
  ...
  void getCreatePublicationReturnsLexvoUriWhenInputIsValidLanguage(
      String attribute, String language, URI expectedUri)
      throws IOException, InterruptedException, MetadataFetchException {
    var actualLanguage =
        getCreatePublicationRequest(attribute, language).getEntityDescription().getLanguage();
    var expectedLanguage =
        createPublicationRequestWithLanguageOnly(expectedUri).getEntityDescription().getLanguage();
  ...
  void getCreatePublicationReturnsLexvoUndUriWhenInputIsInvalidLanguage(
      String attribute, String code, URI expectedUri)
      throws IOException, InterruptedException, MetadataFetchException {
    var actualLanguage =
        getCreatePublicationRequest(attribute, code).getEntityDescription().getLanguage();
    var expectedLanguage =
        createPublicationRequestWithLanguageOnly(expectedUri).getEntityDescription().getLanguage();
  ...
  @Test
  void getCreatePublicationReturnsNoValueWhenDcTermsElementIsUnknown()
      throws IOException, InterruptedException, MetadataFetchException {
    Optional<CreatePublicationRequest> request =
        getCreatePublicationRequestResponse(DC_MISSPELT, IRRELEVANT);
    assertTrue(request.isEmpty());
  }

  @ParameterizedTest
  @ArgumentsSource(ValidDoiStringArgumentsProvider.class)
  void getCreatePublicationRequestReturnsHttpsDoiWhenInputIsDoiString(
      String metaTagName, String metaTagContent, URI expected)
      throws IOException, InterruptedException, MetadataFetchException {
  ...
  @ParameterizedTest(
      name = "HTTPS DOI extracted from META tag name {0} and content DOI pseudo-URN {1}")
  @ArgumentsSource(ValidDoiPseudoUrnArgumentsProvider.class)
  void getCreatePublicationRequestReturnsHttpsDoiWhenInputIsPseudoUrnOrPlainDoi(
      String metaTagName, String metaTagContent, URI expected)
      throws IOException, InterruptedException, MetadataFetchException {
    CreatePublicationRequest createPublicationRequest =
        getCreatePublicationRequest(metaTagName, metaTagContent);
  ...
  void getCreatePublicationRequestReturnsHttpsDoiWhenInputIncludesValidHttpOrHttpsDoi(
      String metaTagName, String metaTagContent, URI expected)
      throws IOException, InterruptedException, MetadataFetchException {
    CreatePublicationRequest createPublicationRequest =
        getCreatePublicationRequest(metaTagName, metaTagContent);
  ...
  void getCreatePublicationRequestReturnsHttpsDoiWhenInputIncludesValidShortDoi(
      String metaTagName, String metaTagContent, URI expected)
      throws IOException, InterruptedException, MetadataFetchException {
    CreatePublicationRequest createPublicationRequest =
        getCreatePublicationRequest(metaTagName, metaTagContent, expected.toString());
    URI actual = createPublicationRequest.getEntityDescription().getReference().getDoi();
    assertThat(actual, equalTo(expected));
  }
  ...
  void getCreatePublicationRequestReturnsSingleHttpsDoiWhenInputContainsManyValidDois()
      throws MetadataFetchException {
    List<MetaTagPair> doimetaTagPairs =
        List.of(
    ...
    CreatePublicationRequest createPublicationRequest =
        getCreatePublicationRequest(doimetaTagPairs);
  ...
  void getCreatePublicationRequestReturnsContributorWhenInputIsValidContributor(
      List<MetaTagPair> tags) throws MetadataFetchException {
    ...
    Object[] expected =
        tags.stream()
            ...
            .toArray();
    List<String> actual =
        request.getEntityDescription().getContributors().stream()
  ...
  void getCreatePublicationRequestReturnsTitleWhenInputContainsMetaTitle(
      String metaTagName, String metaTagContent)
      throws IOException, InterruptedException, MetadataFetchException {
    CreatePublicationRequest request = getCreatePublicationRequest(metaTagName, metaTagContent);
    String actual = request.getEntityDescription().getMainTitle();
  ...
  void getCreatePublicationRequestReturnsLongestTitleWhenInputContainsMultipleTitles(
      String first, String second, String third, String expected) throws MetadataFetchException {
    String shortAuthorName = createAuthorShorterThanShortestTitle(first, second, third);
    List<MetaTagPair> metaTags =
        List.of(
            new MetaTagPair(DC_TITLE, first),
            new MetaTagPair(CITATION_TITLE, second),
            new MetaTagPair(CITATION_AUTHOR, shortAuthorName));
    CreatePublicationRequest createPublicationRequest =
        getCreatePublicationRequest(third, metaTags);
    String actual = createPublicationRequest.getEntityDescription().getMainTitle();
    List<String> authorNames =
        createPublicationRequest.getEntityDescription().getContributors().stream()
            .map(Contributor::identity)
            .map(Identity::getName)
            .collect(Collectors.toList());
  ...
  void getCreatePublicationRequestReturnsTypeWhenInputIndicatesType(
      String metaTagName,
      ...
      throws MetadataFetchException {
    CreatePublicationRequest createPublicationRequest =
        getCreatePublicationRequest(
            List.of(
                new MetaTagPair(CITATION_DOI, "10.0000/aaaa"),
                new MetaTagPair(metaTagName, isxnImplyingContentType)));

    PublicationContext actualContext =
        createPublicationRequest.getEntityDescription().getReference().getPublicationContext();
    ...
    PublicationInstance actualInstance =
  ...
  @DisplayName(
      "getCreatePublicationRequest consumes multiple ISBNs adding distinct, converting ISBN-10 to"
          + " ISBN-13")
  @Test
  void getCreatePublicationRequestReturnsMultipleIsbnsWhenMultipleIsbnsArePresent()
    ...
    List<String> actual =
        ((Book)
            ...
            .isbnList();
    String[] expected =
        List.of(FIRST_ISBN_ISBN13_VARIANT, SECOND_ISBN_ISBN13_VARIANT).toArray(String[]::new);
  ...
  @Test
  void getCreatePublicationRequestIgnoresInvalidIsbns() throws MetadataFetchException {
    CreatePublicationRequest createPublicationRequest =
        getCreatePublicationRequest(
            List.of(new MetaTagPair(Citation.ISBN.getMetaTagName(), INVALID_ISXN)));
    ...
    String actual =
        ((UnconfirmedJournal)
                createPublicationRequest
                    ...
                    .getPublicationContext())
            .onlineIssn();
    String[] expected = List.of(ONLINE_ISSN, PRINT_ISSN).toArray(String[]::new);
  ...
  @ParameterizedTest
  @ValueSource(
      strings = {"dcterms.dateAccepted", "dcterms.dateCopyrighted", "dcterms.dateSubmitted"})
  void getCreatePublicationRequestReturnsOptionalEmptyWhenInputIsValidButUnmappedDate(
      String property) throws IOException, InterruptedException, MetadataFetchException {
  ...
  void getCreatePublicationRequestReturnsOptionalEmptyWhenExpectedInputIsStringButInputIsUri(
      String property) throws MetadataFetchException {
    Optional<CreatePublicationRequest> createPublicationRequest =
  ...
  void getCreatePublicationRequestReturnsOptionalEmptyWhenExpectedInputIsInvalidIsxn()
    ...
    assertThat(
        ...
        hasItem(containsString("Could not extract type metadata from statement ")));
  }
  ...
  private static Stream<Arguments> provideMetadataWithLowercasePrefixes() {
    ...
    return Stream.of(
        generateTestHtml(
            "Lowercase dc.title still maps to mainTitle in createRequest",
            Map.of(DC_TITLE_LOWERCASE, title),
            request),
        generateTestHtml(
            "Lowercase dcterms.abstract still maps to abstract in createRequest",
            Map.of(DCTERMS_ABSTRACT_LOWERCASE, abstractString),
            abstractOnlyRequest));
  }

  private static CreatePublicationRequest createRequestWithTitle(String title) {
    EntityDescription entityDescription =
        new EntityDescription.Builder().withMainTitle(title).build();
  ...
  private static Stream<Arguments> provideMetadataForAbstract() {
    ...
    CreatePublicationRequest request =
        createRequestWithDescriptionAndOrAbstract(description, abstractString);
    CreatePublicationRequest abstractOnlyRequest =
        createRequestWithDescriptionAndOrAbstract(null, abstractString);

    return Stream.of(
        generateTestHtml(
            "DCTERMS.abstract and DC.description maps to respective tags in createRequest",
            Map.of(DCTERMS_ABSTRACT, abstractString, DC_DESCRIPTION, description),
            request),
        generateTestHtml(
            "Without DCTERMS.abstract maps DC.description to abstract in createRequest",
            Map.of(DC_DESCRIPTION, abstractString),
            abstractOnlyRequest),
        generateTestHtml(
            "Without DC.description, DCTERMS.abstract maps to abstract in createRequest",
            Map.of(DCTERMS_ABSTRACT, abstractString),
            abstractOnlyRequest));
  }
  ...
  private static Arguments generateTestHtml(
      String testDescription, Map<String, String> metadata, CreatePublicationRequest expected) {
  ...
  private static String createHtml(String htmlTitle, List<MetaTagPair> metaTags) {
    ...
    EmptyTag[] headTags =
        metaTags.stream().map(MetadataServiceTest::getMetaTag).toArray(EmptyTag[]::new);
  ...
  private String createAuthorShorterThanShortestTitle(String... titles) {
    return Arrays.stream(titles).reduce(this::shortestString).map(this::leftHalf).orElseThrow();
  }
  ...
  private CreatePublicationRequest getCreatePublicationRequest() throws MetadataFetchException {
  ...
  private CreatePublicationRequest getCreatePublicationRequest(
      String htmlTitle, List<MetaTagPair> metaTags) throws MetadataFetchException {
    String html = createHtml(htmlTitle, metaTags);
    URI uri = prepareWebServerAndReturnUriToMetadata(html);
    MetadataService metadataService = new MetadataService();
    Optional<CreatePublicationRequest> request =
        metadataService.generateCreatePublicationRequest(uri);
  ...
  private CreatePublicationRequest getCreatePublicationRequest(String attribute, String value)
      throws IOException, InterruptedException, MetadataFetchException {
    Optional<CreatePublicationRequest> request =
        getCreatePublicationRequestResponse(attribute, value);
    return request.orElseThrow();
  }
  ...
  private CreatePublicationRequest getCreatePublicationRequest(
      ...
      throws IOException, InterruptedException, MetadataFetchException {
    Optional<CreatePublicationRequest> request =
        getCreatePublicationRequestResponse(attribute, value, expected);
    return request.orElseThrow();
  }
  ...
  private Optional<CreatePublicationRequest> getCreatePublicationRequestResponseWithRdfSource(
      String property) throws MetadataFetchException {
  ...
  private CreatePublicationRequest createPublicationRequestWithLanguageOnly(URI uri) {
    EntityDescription entityDescription = new EntityDescription.Builder().withLanguage(uri).build();
  ...
  private CreatePublicationRequest getCreatePublicationRequestWithDateOnly(String date) {
    EntityDescription entityDescription =
        new EntityDescription.Builder().withPublicationDate(createPublicationDate(date)).build();
    CreatePublicationRequest expectedRequest = new CreatePublicationRequest();
    expectedRequest.setEntityDescription(entityDescription);
    return expectedRequest;
  }
  ...
  private void startMock(String body) {
    configureFor("localhost", wireMockServer.port());
    stubFor(
        get(urlEqualTo("/article/" + MetadataServiceTest.ARTICLE_HTML))
