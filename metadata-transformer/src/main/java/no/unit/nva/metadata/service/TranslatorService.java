...
public class TranslatorService {
  ...
  public static final String FAILED_TO_EXTRACT_TRIPLES_FROM_DOCUMENT =
      "Failed to extract triples from the document";
   ...
   */
  public Model loadMetadataFromUri(URI uri)
      throws URISyntaxException, IOException, ExtractionException {
