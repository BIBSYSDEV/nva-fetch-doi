...
public final class IsbnCleaner {
  ...
  public static final String ERROR_WHEN_TRYING_TO_CLEAN_ISSN =
      "Error when trying to clean ISBN: {}";

  private IsbnCleaner() {}

  /**
   * Takes an input string that is an ISBN candidate, tests it and formats it if possible or returns
   * null.
   *
  ...
  private static String stripSeparatorAndWhitespace(String value) {
    return nonNull(value)
        ? removeMultipleWhiteSpaces(value).replaceAll(INVALID_CHARS, EMPTY_STRING)
        : null;
  }
