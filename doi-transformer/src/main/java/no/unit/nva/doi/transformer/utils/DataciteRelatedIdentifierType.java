...
public enum DataciteRelatedIdentifierType {
  ...
  /**
   * Method returns a type based on input code, returns UNKNOWN_IDENTIFIER if type is unknown or
   * null.
   *
  ...
  private static boolean matchesDataciteIdentifierType(
      String code, DataciteRelatedIdentifierType type) {
  ...
  private static boolean isKnown(DataciteRelatedIdentifierType dataciteRelatedIdentifierType) {
    return dataciteRelatedIdentifierType != UNKNOWN_IDENTIFIER;
  }
