...
public enum LicensingIndicator {
  ...
  /**
   * Takes a license URI or URN as a String and matches against known license types. If the input is
   * unknown, false is returned.
   *
   * <p>The methodology here is that ALL creative commons licenses are considered open, while
   * ERS/COAR URNs reflect open/closed status directly. An unknown license is assumed to be not
   * open.
   *
