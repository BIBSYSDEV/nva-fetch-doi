...
public final class IssnCleaner {
  ...
  /**
   * Takes an input string that is an ISSN candidate, tests it and formats it if possible or returns
   * null.
   *
  ...
  private static String stripSeparatorAndWhitespace(String value) {
    ...
    String cleanedString =
        StringUtils.removeMultipleWhiteSpaces(value).replaceAll(INVALID_CHARS, EMPTY_STRING);
