...
public class StringUtilsTest {
  ...
  @Test
  @DisplayName(
      "parsePage returns a \"begin\" repeating \"begin\" for page string with as single number")
  ...
  @Test
  @DisplayName(
      "parsePage returns a \"begin\" and \"end\" for page strings that have prefix word with"
          + " space.")
