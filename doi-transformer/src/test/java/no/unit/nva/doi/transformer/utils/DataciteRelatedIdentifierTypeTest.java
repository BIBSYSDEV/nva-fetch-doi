...
class DataciteRelatedIdentifierTypeTest {
  ...
  void dataciteRelatedIdentifiersGetDescriptionReturnsDescriptionWhenInputCodeIsValid(
      String value) {
  ...
  void dataciteRelatedIdentifiersGetByCodeReturnUnknownCodeWhenInputCodeIsInvalid(String value) {
    assertEquals(
        DataciteRelatedIdentifierType.UNKNOWN_IDENTIFIER,
        DataciteRelatedIdentifierType.getByCode(value));
  }
  ...
  void dataciteRelatedIdentifiersGetByCodeReturnUnknownCodeWhenInputCodeIsINull() {
    assertEquals(
        DataciteRelatedIdentifierType.UNKNOWN_IDENTIFIER,
        DataciteRelatedIdentifierType.getByCode(null));
  }
}
