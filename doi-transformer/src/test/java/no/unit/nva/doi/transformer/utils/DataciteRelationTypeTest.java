...
class DataciteRelationTypeTest {
  ...
  void getByRelationReturnsNonExistingRelationWhenInputDoesNotMatchExistingRelation(String input) {
    assertEquals(
        DataciteRelationType.NON_EXISTING_RELATION, DataciteRelationType.getByRelation(input));
  }
  ...
  void getByRelationReturnsNonExistingRelationWhenInputIsNull() {
    assertEquals(
        DataciteRelationType.NON_EXISTING_RELATION, DataciteRelationType.getByRelation(null));
  }
}
