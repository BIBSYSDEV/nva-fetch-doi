...
class LanguageMapperTest {
  ...
  @Test
  public void getUriFromIsoThrowsLanguageUriNotFoundExceptionOnGarbageInput()
      throws LanguageUriNotFoundException {
    LanguageUriNotFoundException exception =
        assertThrows(
            LanguageUriNotFoundException.class, () -> LanguageMapper.getUriFromIso(GARBAGE_INPUT));

    Assertions.assertEquals(
        LanguageMapper.URI_NOT_FOUND_ERROR + GARBAGE_INPUT, exception.getMessage());
