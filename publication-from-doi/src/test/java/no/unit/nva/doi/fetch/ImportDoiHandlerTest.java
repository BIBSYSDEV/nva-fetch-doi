...
class ImportDoiHandlerTest extends DoiHandlerTestUtils {
  ...
  void testOkResponse() throws Exception {
    ...
    var isDoi = true;
    var expectedCreateRequest = expectedCreatePublicationRequest(isDoi, URI.create(VALID_DOI));
  ...
  @Test
  void handleRequestReturnsSummaryWithIdentifierWhenUrlIsValidNonDoi() throws Exception {
    ...
    var isDoi = false;
    var expectedCreateRequest = expectedCreatePublicationRequest(isDoi, URI.create(VALID_NON_DOI));
  ...
  void testBadRequestResponse() throws Exception {
    ...
    var importDoiHandler =
        new ImportDoiHandler(
    ...
    assertEquals(HTTP_BAD_REQUEST, gatewayResponse.getStatusCode());
    assertThat(
        getProblemDetail(gatewayResponse), containsString(ImportDoiHandler.NULL_DOI_URL_ERROR));
  }
  ...
  void testInternalServerErrorResponse() throws Exception {
    ...
    assertThat(
        getProblemDetail(gatewayResponse),
        containsString(
  ...
  void handlerReturnsBadRequestWhenDoiProxyServiceReturnsNoMetadata() throws Exception {
    ...
    assertThat(
        getProblemDetail(gatewayResponse), containsString(DoiProxyService.ERROR_READING_METADATA));
  }
  ...
  void handlerReturnsBadGatewayErrorWhenResourcePersistenceServiceReturnsFailedResponse()
    ...
    var publicationPersistenceService = mockResourcePersistenceServiceReceivingFailedResult();
    ...
    assertThat(
        getProblemDetail(gatewayResponse),
        containsString(PublicationPersistenceService.WARNING_MESSAGE));
  }
  ...
  private Summary createSummary() {
    return new Summary.Builder()
        ...
        .withDate(new PublicationDate.Builder().withYear("2020").build())
        .build();
  }
  ...
  private GatewayResponse<Summary> parseSuccessResponse(String output)
